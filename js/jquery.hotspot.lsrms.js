...
(function() {
	...
	*/
	function _positionHotspots(options) {
		...
		// position on the red hot spots
		$(options.red_selector).each(function() {
		...
		// position on the green hot spots
		$(options.green_selector).each(function() {
			var xPos = $(this).attr('x');
			var yPos = $(this).attr('y');
			xPos = xPos / imageWidth * bannerWidth;
			yPos = yPos / imageHeight * bannerHeight;
	...
	// HCW (14-Oct-18): Take out temporarily
	...
	$.fn.hotSpot.defaults = {
		...
		red_selector: '.red-hot-spot',
		green_selector: '.green-hot-spot',
